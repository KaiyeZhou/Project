...
def vis_one_image(
    ...
    if keypoints is not None:
        plt.savefig('/home/server010/zhoukaiye/jianshen/jianshenshuju/test/testpic3.jpg', dpi = 25)
        plt.close()
        vis_img = cv2.imread('/home/server010/zhoukaiye/jianshen/jianshenshuju/test/testpic3.jpg')
        return vis_img
