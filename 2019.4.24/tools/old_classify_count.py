...
def classify_count():
    ...
    data1 = sio.loadmat("/home/server010/server010/333.mat")['name'][:, 0:2, :]       #699x2x17
    ...
    #     if start_frame:
    #         if i - start_frame[-1] > 60 and abs(data1[i][1][9] - data1[start_frame[-1]][1][9] < 10):
    #             if i - tmp >40:
    #                 flag = 0
    #                 count1 += 1
    #             tmp = i    
        ...
        for i in range(len(data1)):
            if i + 20 < len(data1) and data1[i+20][1][9] - data1[i][1][9] > 90:
                ...
                if start_frame and i - start_frame[-1] > 30:
                    start_frame.append(i)
            if start_frame:
                if i - start_frame[-1] > 60 and abs(data1[i][1][9] - data1[start_frame[-1]][1][9]) < 20:
                    if i - tmp >40:
                        flag = 0
                        count2 += 1
                    tmp = i
