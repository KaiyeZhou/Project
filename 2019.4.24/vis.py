...
def vis_one_image(
        im, boxes,im_name=None, output_dir=None, segms=None, keypoints=None, body_uv=None, thresh=0.9,
    ...
    if segms is not None and len(segms) > 0:
        masks = mask_util.decode(segms)
    ########
    # mat_path = '/home/server010/zhoukaiye/jianshen/jianshenshuju/test/coordinate-161441-convert-boxes.mat'
    # io.savemat(mat_path, {'name':boxes})
    ########
    ...
    if keypoints is not None:
        plt.savefig('/home/server010/server010/FitNess/Video_capture/video_out/test1.jpg', dpi = 200)
        plt.close()
        vis_img = cv2.imread('/home/server010/server010/FitNess/Video_capture/video_out/test1.jpg')
        return vis_img
